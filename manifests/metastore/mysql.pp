...
#                   Default: 0.12.0
#
class hive::metastore::mysql($schema_version = '0.12.0') {
    Class['hive'] -> Class['hive::metastore::mysql']
    ...
    $db_name = $hive::jdbc_database
    $db_user = $hive::jdbc_username
    $db_pass = $hive::jdbc_password
