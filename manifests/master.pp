...
#                       the name of a hive::metastore::* class in
#                       hive/metastore/*.pp.
#
class hive::master($metastore_database = 'mysql') {
    class { 'hive::server':    }
    class { 'hive::metastore': }

    # Set up the metastore database by including
    # the $metastore_database_class.
    $metastore_database_class = "hive::metastore::${metastore_database}"
    ...
    Class[$metastore_database_class] -> Class['hive::metastore']
}
